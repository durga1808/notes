...
@ApplicationScoped
@Identifier("event-failure-fallback")
public class EventDeserializerFailureHandler implements DeserializationFailureHandler<OtelEvents>{
    
    @Override
  public OtelEvents handleDeserializationFailure(
    final String topic,
    final boolean isKey,
